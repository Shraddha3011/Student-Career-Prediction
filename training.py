...
Original file is located at
    https://colab.research.google.com/drive/1oQwi9Lqu8-eXa88oGdaJDFgLQhXqLOmD
"""
...
#XGBoost Classifier
clf2 = AdaBoostClassifier(random_state = 42, learning_rate=0.02, n_estimators=300)
...
# Random Forest Model
file1 = open('/content/model1.pkl', 'wb')
pickle.dump(clf1, file1)
file1.close()

# XGBoost Model
file2 = open('/content/model2.pkl', 'wb')
